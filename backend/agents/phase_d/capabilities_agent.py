...
キャラクターが実際に持っているもの、できること、とれる行動を「濃密に」設計してください。
...
【設計原則】
1. 所持品はただの道具リストではなく、キャラクターの人生・感情・価値観を体現するものにすること
   - 例: 「古い手帳」ではなく「亡くなった父から受け継いだ革張り手帳。使い込んで角が擦り切れている。名前のページだけが丁寧に書き換えられていた」
...
2. 【感情的深み】possessionsのemotional_significanceは、読んでいて心が動くか？
   「大事にしている」程度の記述で終わっていないか？
3. 【能力の根拠】abilitiesのoriginを読んで、「なるほど、この人が持つのは自然だ」と思えるか？
   唐突に付け足した感のある能力はないか？
4. 【行動の実用性】available_actionsは、脚本AIがイベント生成時に実際に使えるか？
