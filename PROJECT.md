...
├── backend/
│   ├── main.py                                # FastAPI エントリポイント (WebSocket + REST API) ※2026-04-18 17:25 再起動完了 (PID: 25972)
...
- **(c) 採用したベストプラクティス**:
  - **最新の状態**: プロセス再起動完了 (2026-04-18 16:40)
  - **詳細**: ポート 8001 にて新規プロセス (PID 24392) を起動し、`python -m backend.main` によりサーバーを再開。動作確認済み。
